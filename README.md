...
- ALT 目前版本：**1.2.0**
- 明確支援的 Antigravity 版本：**2.13.0、2.14.0、2.15.0**
- 正式驗證平台：**Windows x64**
...
1. 先安裝並更新官方 Antigravity 至明確支援的 **2.13.0、2.14.0 或 2.15.0**。
...
- ALT 1.2.0 明確支援 Antigravity **2.13.0、2.14.0、2.15.0**。
...
ALT 1.2.0 明確支援 Antigravity **2.13.0、2.14.0 與 2.15.0**。其他版本不會因版本號較新就自動放行，必須先完成相容性驗證。
