...
將 Antigravity 2.0 的介面翻譯為繁體中文（台灣）。請安裝最新版本 v1.0.6，以符合 Antigravity 2.0 官方最新介面。支援 Windows 與 macOS，完成 Node.js 與 `npm install` 後可雙擊腳本安裝與還原。
...
為確保翻譯內容與 Antigravity 2.0 官方最新介面一致，建議安裝本套件最新版本 v1.0.6。
