...
- CI: pending PR execution; to be updated after controlled CI completes.
- PR: pending creation to `main`; must not be merged by Codex.
- Remaining blockers: controlled CI pending only.
