...
- Review follow-up local validation: `npm run check`, `npm run check:packaging`, Windows x64 build, and `npm run check:windows-installer` passed. Follow-up CI is pending for the new PR head.
