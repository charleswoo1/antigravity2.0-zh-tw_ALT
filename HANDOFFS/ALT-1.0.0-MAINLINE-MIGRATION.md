...
- Windows validation: `VALIDATED_ON_WINDOWS_X64`. Both Inno Setup EXEs built successfully and passed isolated end-to-end tests. The final local artifacts were `Antigravity-ZH-Hant-TW-ALT-1.0.0-Windows.exe` (SHA-256 `9C8D8DCFF19E17BB8311C2B0DEDB99753A56AE112B31D4E8C0145E4E6198FAC5`) and `Antigravity-ZH-Hant-TW-ALT-1.0.0-Windows-Restore.exe` (SHA-256 `44BC923E900C24E94819A985BEB9F1086BEF5C857252089DE175C2FF915F464A`). Generated artifacts remain ignored and are not committed.
